...
export const MAINNET_SMOOTHY_POOLS = {
    syUSD: {
        poolAddress: '0xe5859f4efc09027a9b718781dcb2c6910cac6e91',
        tokens: [TOKENS.USDT, TOKENS.USDC, TOKENS.DAI, TOKENS.TUSD, TOKENS.sUSD, TOKENS.BUSD, TOKENS.PAX, TOKENS.GUSD],
    },
};
...
export const DEFAULT_GAS_SCHEDULE: Required<FeeSchedule> = {
    ...
    [ERC20BridgeSource.Curve]: fillData => {
        ...
        switch (poolAddress) {
            ...
            case POOLS.curve_sBTC:
                return 337e3;
            case POOLS.curve_link:
                return 329e3;
            case POOLS.curve_UST:
                return 350e3;
            case POOLS.curve_eurs:
                return 330e3;
            case POOLS.curve_USDP:
                return 384e3;
            case POOLS.curve_dUSD:
                return 381e3;
            case POOLS.curve_mUSD:
                return 395e3;
            case POOLS.curve_alUSD:
                return 397e3;
            case POOLS.curve_HUSD:
                return 406e3;
            case POOLS.curve_STABLEx:
                return 407e3;
            case POOLS.curve_TUSD:
                return 414e3;
    ...
    [ERC20BridgeSource.Smoothy]: () => 200e3,
